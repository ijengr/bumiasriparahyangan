        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="space-y-8" data-aos="fade-right">
                <div class="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm shadow-lg border border-emerald-100 text-emerald-700 px-5 py-2.5 rounded-full text-sm font-semibold">
                    ...
                    <span class="bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">Hunian Premium di Parahyangan</span>
                </div>

                <h1 class="text-5xl sm:text-6xl lg:text-7xl font-extrabold text-gray-900 leading-tight">
                    <span class="block">Temukan Hunian</span>
                    <span class="block bg-gradient-to-r from-emerald-600 via-teal-600 to-emerald-700 bg-clip-text text-transparent">Impian Anda</span>
                </h1>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-6">
                    <div class="group relative p-5 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-emerald-100/50 hover:border-emerald-200 overflow-hidden">
                        ...
                        <div class="relative flex items-center gap-4">
                            <div class="flex-shrink-0 w-14 h-14 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl flex items-center justify-center shadow-lg transform group-hover:scale-110 group-hover:rotate-3 transition-transform">
                    ...
                    <div class="group relative p-5 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-blue-100/50 hover:border-blue-200 overflow-hidden">
                        ...
                        <div class="relative flex items-center gap-4">
                            <div class="flex-shrink-0 w-14 h-14 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl flex items-center justify-center shadow-lg transform group-hover:scale-110 group-hover:rotate-3 transition-transform">
                    ...
                    <div class="group relative p-5 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-green-100/50 hover:border-green-200 overflow-hidden">
                        ...
                        <div class="relative flex items-center gap-4">
                            <div class="flex-shrink-0 w-14 h-14 bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl flex items-center justify-center shadow-lg transform group-hover:scale-110 group-hover:rotate-3 transition-transform">
                            ...
                            <div class="absolute top-6 right-6 flex flex-col gap-3">
                                <div class="bg-white/95 backdrop-blur-md px-5 py-3 rounded-2xl shadow-2xl border border-white/20">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span class="text-sm font-bold text-gray-900">Unit Tersedia</span>
                                    </div>
                                </div>
                                <div class="bg-gradient-to-r from-emerald-600 to-teal-600 px-5 py-3 rounded-2xl shadow-2xl">
                                    <div class="flex items-center gap-2 text-white">
                                        ...
                                        <span class="text-sm font-bold">Premium</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-8 lg:p-10 bg-gradient-to-br from-white to-emerald-50/30">
                            ...
                            <div class="mt-8 flex flex-wrap items-center gap-6">
                                <div class="flex -space-x-3">
                                    <div class="w-12 h-12 rounded-full bg-gradient-to-br from-emerald-400 to-emerald-600 border-4 border-white shadow-lg"></div>
                                    <div class="w-12 h-12 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 border-4 border-white shadow-lg"></div>
                                    <div class="w-12 h-12 rounded-full bg-gradient-to-br from-purple-400 to-purple-600 border-4 border-white shadow-lg"></div>
                                    <div class="w-12 h-12 rounded-full bg-gradient-to-br from-pink-400 to-pink-600 border-4 border-white shadow-lg flex items-center justify-center text-white font-bold text-sm">+50</div>
                                </div>
                                <div class="flex-1">
...
<section class="relative bg-gradient-to-br from-emerald-600 via-emerald-700 to-teal-600 py-16 lg:py-24 overflow-hidden">
    ...
    <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-full">
        <div class="absolute top-10 left-10 w-2 h-2 bg-white/20 rounded-full"></div>
        <div class="absolute top-20 right-20 w-3 h-3 bg-white/30 rounded-full"></div>
        <div class="absolute bottom-20 left-1/4 w-2 h-2 bg-emerald-300/20 rounded-full"></div>
        <div class="absolute bottom-32 right-1/3 w-3 h-3 bg-teal-300/20 rounded-full"></div>
    </div>
    
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12" data-aos="fade-up">
            <h2 class="text-3xl lg:text-4xl font-extrabold text-white mb-3">Dipercaya Ratusan Keluarga</h2>
            <p class="text-emerald-100 text-lg">Angka yang membuktikan komitmen kami</p>
        </div>
        
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            <!-- Counter 1: Total Units -->
            <div class="text-center transform hover:scale-105 transition-transform duration-300" data-aos="fade-up" data-aos-delay="0">
                <div class="flex items-center justify-center mb-4">
                    <div class="p-4 bg-white/10 backdrop-blur-sm rounded-2xl shadow-xl">
            ...
            <!-- Counter 2: Happy Families -->
            <div class="text-center transform hover:scale-105 transition-transform duration-300" data-aos="fade-up" data-aos-delay="100">
                <div class="flex items-center justify-center mb-4">
                    <div class="p-4 bg-white/10 backdrop-blur-sm rounded-2xl shadow-xl">
                        <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="text-emerald-100 font-semibold text-sm lg:text-base">Keluarga Bahagia</div>
            </div>

            <!-- Counter 3: Premium Facilities -->
            <div class="text-center transform hover:scale-105 transition-transform duration-300" data-aos="fade-up" data-aos-delay="200">
                <div class="flex items-center justify-center mb-4">
                    <div class="p-4 bg-white/10 backdrop-blur-sm rounded-2xl shadow-xl">
                        <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="text-center transform hover:scale-105 transition-transform duration-300" data-aos="fade-up" data-aos-delay="300">
                <div class="flex items-center justify-center mb-4">
                    <div class="p-4 bg-white/10 backdrop-blur-sm rounded-2xl shadow-xl">
                        <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="text-emerald-100 font-semibold text-sm lg:text-base">Tahun Pengalaman</div>
            </div>
        </div>
        
        <!-- Trust Badges -->
        <div class="mt-12 pt-12 border-t border-white/10" data-aos="fade-up" data-aos-delay="400">
...
// Animated Counter - Count up when element is visible
const counters = document.querySelectorAll('.counter');
const counterSpeed = 200; // Animation duration
