...
<div class="mb-4 md:mb-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div class="flex gap-2">
            ...
            <?php else: ?>
                <form action="<?php echo e(route('admin.settings.seed')); ?>" method="POST" onsubmit="return confirm('Update/tambahkan settings yang belum ada ke database?')">
                    <?php echo csrf_field(); ?>
...
async function previewImage(input, previewId, fieldId) {
    ...
    if (!validTypes.includes(file.type)) {
        alert('Format file tidak valid. Gunakan JPG, PNG, SVG, ICO, atau WebP.');
        input.value = '';
        return;
    }
...
function resetTheme() {
    if (!confirm('Reset semua warna ke tema default Emerald?')) return;
