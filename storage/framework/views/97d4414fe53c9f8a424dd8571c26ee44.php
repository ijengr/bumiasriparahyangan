    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-3xl mx-auto" data-aos="fade-up">
            <div class="inline-flex items-center gap-2 px-4 py-2 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 text-sm font-semibold rounded-full mb-4">
                ...
                <?php echo e($siteSettings['badge_facilities'] ?? 'FASILITAS LENGKAP'); ?>

            </div>
            <h1 class="text-4xl lg:text-5xl font-extrabold text-gray-900 dark:text-white mb-4">
                <?php echo e($siteSettings['facilities_title'] ?? 'Nikmati Fasilitas Premium'); ?>

            </h1>
            <p class="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                <?php echo e($siteSettings['facilities_subtitle'] ?? 'Berbagai fasilitas modern dan lengkap untuk mendukung gaya hidup aktif dan sehat bagi seluruh keluarga.'); ?>
        ...
        <?php if($facilities->count() > 0): ?>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                ...
                <?php $__currentLoopData = $facilities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $facility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    ?>
                    <div class="group bg-white dark:bg-gray-800 rounded-2xl shadow-lg dark:shadow-gray-900/50 hover:shadow-2xl border border-gray-100 dark:border-gray-700 overflow-hidden transition-all duration-300 transform hover:-translate-y-2" data-aos="fade-up" data-aos-delay="<?php echo e(($index % 6) * 100); ?>">
                        <div class="relative h-48 bg-gradient-to-br <?php echo e($colorSet[0]); ?> <?php echo e($colorSet[1]); ?> overflow-hidden">
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2 group-hover:<?php echo e($colorSet[2]); ?> <?php echo e($colorSet[4]); ?> transition-colors"><?php echo e($facility->name); ?></h3>
                            <p class="text-gray-600 dark:text-gray-400 leading-relaxed"><?php echo e($facility->description); ?></p>
                        </div>
                    </div>
...
<section class="py-16 bg-gradient-to-br from-green-600 to-emerald-600 dark:from-green-700 dark:to-emerald-700 relative overflow-hidden">
    ...
    <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center" data-aos="zoom-in">
        <h2 class="text-3xl lg:text-4xl font-bold text-white mb-4">
            <?php echo e($siteSettings['facilities_cta_title'] ?? 'Ingin Tahu Lebih Banyak?'); ?>

        </h2>
        <p class="text-xl text-green-100 mb-8 max-w-2xl mx-auto">
            <?php echo e($siteSettings['facilities_cta_subtitle'] ?? 'Kunjungi lokasi kami dan rasakan langsung kenyamanan fasilitas yang tersedia.'); ?>

        </p>
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="<?php echo e(route('landing.contact')); ?>" class="inline-flex items-center gap-2 bg-white text-green-600 hover:bg-green-50 px-8 py-4 rounded-xl font-bold shadow-xl hover:shadow-2xl transition-all transform hover:-translate-y-1">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                <?php echo e($siteSettings['btn_schedule_visit'] ?? 'Jadwalkan Kunjungan'); ?>

            </a>
            <a href="<?php echo e(route('landing.units')); ?>" class="inline-flex items-center gap-2 bg-green-700 hover:bg-green-800 text-white px-8 py-4 rounded-xl font-bold shadow-lg transition-all">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                <?php echo e($siteSettings['btn_view_units'] ?? 'Lihat Unit'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\BumiAsriParahyangan\resources\views/landing/facilities.blade.php ENDPATH**/ ?>