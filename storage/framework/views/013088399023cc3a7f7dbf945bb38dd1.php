    ...
    <div class="max-w-2xl w-full text-center">
        ...
        <div class="text-sm text-gray-600">
            ...
            <div class="flex flex-wrap gap-4 justify-center">
                ...
                <span>•</span>
                <a href="<?php echo e(url('/units')); ?>" class="hover:text-emerald-600 transition-colors">Unit</a>
                <span>•</span>
                <a href="<?php echo e(url('/gallery')); ?>" class="hover:text-emerald-600 transition-colors">Galeri</a>
                <span>•</span>
                <a href="<?php echo e(url('/facilities')); ?>" class="hover:text-emerald-600 transition-colors">Fasilitas</a>
                <span>•</span>
                <a href="<?php echo e(url('/contact')); ?>" class="hover:text-emerald-600 transition-colors">Kontak</a>
            </div>
        </div>
    </div>
</body>
</html>
<?php /**PATH D:\Project\BumiAsriParahyangan\resources\views/errors/404.blade.php ENDPATH**/ ?>