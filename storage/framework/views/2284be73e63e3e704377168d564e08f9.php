...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title><?php echo e($siteSettings['meta_title'] ?? ($siteSettings['company_name'] ?? config('app.name', 'Laravel'))); ?></title>
        ...
        <!-- SEO Meta Tags -->
        <meta name="description" content="<?php echo e($siteSettings['meta_description'] ?? 'Hunian nyaman dan asri untuk keluarga Anda'); ?>">
        <meta name="keywords" content="<?php echo e($siteSettings['meta_keywords'] ?? 'properti, rumah, perumahan, hunian'); ?>">
        <meta name="author" content="<?php echo e($siteSettings['company_name'] ?? config('app.name')); ?>">
        ...
        <meta name="theme-color" content="<?php echo e($siteSettings['theme_color'] ?? '#10b981'); ?>">
        
        <!-- Open Graph / Facebook -->
        <meta property="og:type" content="website">
        <meta property="og:url" content="<?php echo e(url()->current()); ?>">
        <meta property="og:title" content="<?php echo e($siteSettings['meta_title'] ?? ($siteSettings['company_name'] ?? config('app.name'))); ?>">
        <meta property="og:description" content="<?php echo e($siteSettings['meta_description'] ?? 'Hunian nyaman dan asri untuk keluarga Anda'); ?>">
        <?php if(!empty($siteSettings['og_image'])): ?>
        <meta property="og:image" content="<?php echo e(asset($siteSettings['og_image'])); ?>">
        <?php endif; ?>
        
        <!-- Twitter -->
        <meta property="twitter:card" content="summary_large_image">
        <meta property="twitter:url" content="<?php echo e(url()->current()); ?>">
        <meta property="twitter:title" content="<?php echo e($siteSettings['meta_title'] ?? ($siteSettings['company_name'] ?? config('app.name'))); ?>">
        <meta property="twitter:description" content="<?php echo e($siteSettings['meta_description'] ?? 'Hunian nyaman dan asri untuk keluarga Anda'); ?>">
        <?php if(!empty($siteSettings['og_image'])): ?>
        <meta property="twitter:image" content="<?php echo e(asset($siteSettings['og_image'])); ?>">
        <?php endif; ?>
        ...
        <style>
            <?php echo \App\Helpers\ThemeHelper::generateCSSVariables(); ?>
    ...
    <body class="font-sans antialiased overflow-x-hidden">
            ...
            <div class="loader-content">
                <div class="loader-logo">
                    <?php if(!empty($siteSettings['company_logo'] ?? null)): ?>
                        <img src="<?php echo e($siteSettings['company_logo']); ?>" alt="Loading" class="w-28 h-28 object-contain">
                    <?php else: ?>
                        <div class="w-28 h-28 bg-white/20 backdrop-blur-sm rounded-3xl flex items-center justify-center border-4 border-white/30">
        ...
        <?php echo $__env->make('layouts.landing-navigation', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                        ...
                        <div class="lg:col-span-1">
                            <div class="flex items-center gap-3 mb-4">
                                ...
                                <div class="w-10 h-10 bg-white rounded-lg flex items-center justify-center p-1">
                                    <img src="<?php echo e($siteSettings['company_logo']); ?>" alt="<?php echo e($siteSettings['company_name'] ?? 'Logo'); ?>" class="w-full h-full object-contain">
                                </div>
                                <?php else: ?>
                                <!-- Default Icon -->
                                ...
                                <?php endif; ?>
                                <h3 class="text-xl font-bold text-white"><?php echo e($siteSettings['company_name'] ?? 'Bumi Asri Parahyangan'); ?></h3>
                            </div>
                            <p class="text-sm text-gray-400 mb-6 leading-relaxed">
                                <?php echo e($siteSettings['company_description'] ?? 'Hunian nyaman dan asri dengan lingkungan hijau, fasilitas modern, dan komunitas yang ramah untuk keluarga Indonesia.'); ?>

                            </p>
                            <!-- Social Media -->
                            <div class="flex gap-3">
                                <?php if(!empty($siteSettings['social_facebook'])): ?>
                                <a href="<?php echo e($siteSettings['social_facebook']); ?>" target="_blank" class="w-9 h-9 bg-gray-800 hover:bg-emerald-600 rounded-lg flex items-center justify-center transition-all transform hover:-translate-y-1">
                                ...
                                <a href="<?php echo e($siteSettings['social_instagram']); ?>" target="_blank" class="w-9 h-9 bg-gray-800 hover:bg-emerald-600 rounded-lg flex items-center justify-center transition-all transform hover:-translate-y-1">
                                ...
                                <a href="<?php echo e($siteSettings['social_whatsapp']); ?>" target="_blank" class="w-9 h-9 bg-gray-800 hover:bg-emerald-600 rounded-lg flex items-center justify-center transition-all transform hover:-translate-y-1">
                                ...
                                <a href="<?php echo e($siteSettings['social_twitter']); ?>" target="_blank" class="w-9 h-9 bg-gray-800 hover:bg-emerald-600 rounded-lg flex items-center justify-center transition-all transform hover:-translate-y-1">
                        ...
                        <div>
                            ...
                            <ul class="space-y-3">
                                <li><a href="<?php echo e(route('landing.index')); ?>" class="text-sm hover:text-emerald-400 transition-colors flex items-center gap-2 group">
                                ...
                                <li><a href="<?php echo e(route('landing.units')); ?>" class="text-sm hover:text-emerald-400 transition-colors flex items-center gap-2 group">
                                    <svg class="w-4 h-4 text-emerald-500 opacity-0 group-hover:opacity-100 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                                    Unit Tersedia
                                </a></li>
                                <li><a href="<?php echo e(route('landing.gallery')); ?>" class="text-sm hover:text-emerald-400 transition-colors flex items-center gap-2 group">
                                    <svg class="w-4 h-4 text-emerald-500 opacity-0 group-hover:opacity-100 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                                    Galeri
                                </a></li>
                                <li><a href="<?php echo e(route('landing.contact')); ?>" class="text-sm hover:text-emerald-400 transition-colors flex items-center gap-2 group">
                                    <svg class="w-4 h-4 text-emerald-500 opacity-0 group-hover:opacity-100 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                                    Kontak
                                </a></li>
                            </ul>
                        ...
                        <div>
                            ...
                            <ul class="space-y-3">
                                <li class="flex items-start gap-3 text-sm">
                                    ...
                                    <span class="text-gray-400"><?php echo nl2br(e($siteSettings['contact_address'] ?? 'Jl. Parahyangan No. 123, Bandung, Jawa Barat 40164')); ?></span>
                                </li>
                                <li class="flex items-center gap-3 text-sm">
                                    ...
                                    <a href="tel:<?php echo e(str_replace([' ', '-', '(', ')'], '', $siteSettings['contact_phone'] ?? '')); ?>" class="text-gray-400 hover:text-emerald-400 transition-colors"><?php echo e($siteSettings['contact_phone'] ?? '+62 22 1234 5678'); ?></a>
                                </li>
                                <li class="flex items-center gap-3 text-sm">
                                    ...
                                    <a href="mailto:<?php echo e($siteSettings['contact_email'] ?? 'info@bumiasriparahyangan.com'); ?>" class="text-gray-400 hover:text-emerald-400 transition-colors"><?php echo e($siteSettings['contact_email'] ?? 'info@bumiasriparahyangan.com'); ?></a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul class="space-y-3 text-sm">
                                <li class="flex justify-between items-center">
                                    ...
                                    <span class="text-white font-semibold"><?php echo e($siteSettings['operating_hours_weekday'] ?? '08:00 - 17:00'); ?></span>
                                </li>
                                <li class="flex justify-between items-center">
                                    <span class="text-gray-400">Sabtu</span>
                                    <span class="text-white font-semibold"><?php echo e($siteSettings['operating_hours_saturday'] ?? '08:00 - 14:00'); ?></span>
                                </li>
                                <li class="flex justify-between items-center">
                                    <span class="text-gray-400">Minggu</span>
                                    <span class="text-emerald-400 font-semibold"><?php echo e($siteSettings['operating_hours_sunday'] ?? 'Tutup'); ?></span>
                                </li>
                            </ul>
                            <div class="mt-6 p-4 bg-gradient-to-br from-emerald-600 to-teal-600 rounded-xl">
                                ...
                                <a href="<?php echo e(route('landing.contact')); ?>" class="inline-flex items-center gap-2 bg-white text-emerald-600 px-4 py-2 rounded-lg text-sm font-bold hover:bg-emerald-50 transition-all w-full justify-center">
                    ...
                    <div class="border-t border-gray-700 mt-12 pt-8">
                        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                            <p class="text-sm text-gray-400">
                                &copy; <?php echo e(date('Y')); ?> <span class="text-emerald-400 font-semibold"><?php echo e($siteSettings['company_name'] ?? 'Bumi Asri Parahyangan'); ?></span>. All rights reserved.
                            </p>
        ...
        <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $siteSettings['contact_whatsapp'])); ?>" 
           target="_blank" 
           rel="noopener noreferrer"
           class="fixed bottom-8 right-8 z-[998] group"
           aria-label="Chat WhatsApp">
            <div class="relative">
                ...
                <!-- Button -->
                <div class="relative w-14 h-14 bg-gradient-to-br from-green-500 to-green-600 rounded-full shadow-lg hover:shadow-2xl flex items-center justify-center transition-all duration-300 transform hover:scale-110 hover:-translate-y-1">
                ...
                <!-- Tooltip -->
                <div class="absolute right-full mr-3 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap">
...
<?php /**PATH D:\Project\BumiAsriParahyangan\resources\views/layouts/app.blade.php ENDPATH**/ ?>