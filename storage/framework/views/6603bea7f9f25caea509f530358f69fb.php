...
<article <?php echo e($attributes->merge(['class' => 'group bg-white rounded-2xl shadow-md border border-emerald-100/50 hover:shadow-2xl hover:border-emerald-200 transition-all duration-300 flex flex-col overflow-hidden hover:-translate-y-2'])); ?>>
    <!-- header image / badge area -->
    <div class="relative rounded-t-2xl overflow-hidden bg-gradient-to-br from-emerald-50 to-teal-50">
        <img src="<?php echo e($imgSrc); ?>" alt="<?php echo e($title); ?>" class="w-full h-48 object-cover group-hover:scale-110 transition-transform duration-500" loading="lazy" onerror="this.onerror=null;this.src='<?php echo e(asset('images/placeholder-square.svg')); ?>';">
    ...
    <div class="p-5 flex-1 flex flex-col">
        <h3 class="text-xl font-bold text-gray-900 mb-2 truncate group-hover:text-emerald-700 transition-colors"><?php echo e($title); ?></h3>
        ...
        <div class="flex items-center gap-2 mb-4 text-gray-600">
            ...
            <span class="text-sm font-semibold"><?php echo e($land_area ? $land_area . ' m²' : '-'); ?></span>
        </div>
        ...
        <div class="grid grid-cols-3 gap-3 mb-5">
            ...
            <div class="flex flex-col items-center gap-2 p-3 bg-gradient-to-br from-emerald-50 to-teal-50/50 rounded-xl border border-emerald-100/50 group-hover:border-emerald-200 transition-colors">
                ...
                <span class="text-sm font-bold text-gray-900"><?php echo e($bedrooms ?? '-'); ?></span>
            </div>
            ...
            <div class="flex flex-col items-center gap-2 p-3 bg-gradient-to-br from-emerald-50 to-teal-50/50 rounded-xl border border-emerald-100/50 group-hover:border-emerald-200 transition-colors">
                ...
                <span class="text-sm font-bold text-gray-900"><?php echo e($bathrooms ?? '-'); ?></span>
            </div>
            ...
            <div class="flex flex-col items-center gap-2 p-3 bg-gradient-to-br from-emerald-50 to-teal-50/50 rounded-xl border border-emerald-100/50 group-hover:border-emerald-200 transition-colors">
                ...
                <span class="text-xs font-bold text-gray-900 whitespace-nowrap"><?php echo e($floor_area ?? '-'); ?> m²</span>
            </div>
        </div>
        ...
        <div class="mt-auto pt-4 border-t border-gray-100">
            <div class="flex items-center justify-between mb-3">
                <div>
                    ...
                    <div class="text-emerald-700 font-bold text-xl">Rp <?php echo e($price ?? '-'); ?></div>
                </div>
            </div>
            ...
            <div class="flex items-center gap-4 text-xs text-gray-500 mb-4">
                ...
                <span class="flex items-center gap-1.5">
                    ...
                    <span class="font-medium"><?php echo e($built_year ?? '-'); ?></span>
                </span>
                ...
                <span class="flex items-center gap-1.5">
                    ...
                    <span class="font-medium"><?php echo e($parking ?? '-'); ?></span>
                </span>
            </div>

            <?php if($id): ?>
                <a href="<?php echo e(route('landing.units.show', $id)); ?>" class="flex items-center justify-center gap-2 w-full text-sm font-bold bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800 text-white px-4 py-3 rounded-xl shadow-md hover:shadow-lg transition-all">
                    Lihat Detail
...
<?php /**PATH D:\Project\BumiAsriParahyangan\resources\views/components/unit-card.blade.php ENDPATH**/ ?>