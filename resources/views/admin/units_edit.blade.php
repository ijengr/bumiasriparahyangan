...
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-600">Perbarui detail unit. Biarkan gambar kosong untuk mempertahankan yang lama.</p>
    </div>

    @include('admin._unit_form', ['unit' => $unit, 'method' => 'PUT'])
</div>
...
// Format price input with thousand separators (.) while typing in edit form
